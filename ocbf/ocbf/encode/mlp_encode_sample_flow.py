...
def main_sample_flow(
    ...
    mean_select_index, mean_convergence, mean_coverage_rate = mean_pre_sample_flow(
        pwd,
        iw,
        iw_method,
        iw_scale,
    ...
    real_stru_num, coverage_convergence, _ = determine_structure_budget(
        element_coverages,
        selection_budget_schedule,
        coverage_threshold_schedule,
    )
    ...
    convergence = coverage_convergence and mean_convergence
