...
def mean_pre_sample_flow(
    ...
    real_stru_num, convergence, _ = determine_structure_budget([min_coverage_rate], selection_budget_schedule, mean_thresholds)
    ...
    return new_tt,convergence,min_coverage_rate
