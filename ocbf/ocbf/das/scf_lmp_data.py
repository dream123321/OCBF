...
def scf_lammps_data(delete_filter_select,pwd):
    ...
    # Encoded-sampling mode writes selected SCF structures to work/*_sample_filter.xyz
    work_sample_files = sorted(glob.glob(os.path.join(pwd, 'work', '*_sample_filter.xyz')))
