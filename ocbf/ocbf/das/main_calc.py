...
from .gen_calc_file import INPUT, poscar2STRU, prepare_qe_input
...
def mkdir_Placefile(dir, num_posacr, calc_dir_num, xyz, scheduler):
...
def main_calc(atom_list, calc_dir_num, path_main, scheduler):
    ...
    mkdir_Placefile(dir, num_posacr, calc_dir_num, atom_list, scheduler)
