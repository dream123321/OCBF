...
Download the [DCBF deployment package](https://github.com/dream123321/DCBF/releases/download/v3-20260813/dcbf_one-button_deployment.tar.gz) provided for this build.
...
source activate.sh
bash verify.sh
dcbf -h "View more functions" (dcbf train -h)
```
...
```bash
dcbf kill dcbf.init_dataset.vasp.test.json 
```
...
```bash
conda create --name dcbf_env python=3.10
cd source/DCBF/dcbf
